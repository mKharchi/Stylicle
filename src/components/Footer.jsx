...
const Footer = () => {
    ...
    return (
        <footer className="bg-gray-900 text-gray-200 py-6  px-32 ">
            <div className="gap-12 mx-auto flex flex-col  items-center justify-between px-4">
                <div className="flex items-center justify-between w-full">
                    <img src="/logo.png" className="w-20 h-7" />
                ...
                <div className="grid w-full grid-cols-3 justify-items-end ">
                ...
                <div className="flex items-center justify-center w-full">
                        <p>Copyright 2023, @ServiceMarket.dk | All rights reserved.</p>
