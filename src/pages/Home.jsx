...
const SearchBar = () => {
    return (
        <div className='flex rounded-full items-center justify-center w-full max-w-2xl bg-white shadow-md mt-6  p-4'>
            <input
                type="text"
            ...
            <input type="text"
                ...
                className="ml-4 flex-grow px-4 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <button className="ml-4  px-6 py-2 bg-primary text-white rounded-full hover:opacity-80 transition-all duration-300">
...
const Galery = () => {
    return (
        <div className='flex mt-5 py-6 flex-col w-full items-center justify-center gap-6 px-20'>
            ...
            <div className='grid grid-cols-3 gap-4 w-full  rounded-4xl overflow-hidden '>
                <img src="/image1.png" className='row-span-2' alt="" />
...
const Services = () => {
    ...
    return (
        <div className='flex w-full items-center justify-center p-4 px-20 '>
...
const Recommended = () => {
    ...
    return (
        <div className='flex flex-col items-center overflow-x-scroll  w-full  px-20 justify-center gap-2 min-h-screen bg-bg-white '>
            ...
            <div className='flex items-center justify-start gap-10 overflow-x-scroll w-full  ' style={{ scrollbarWidth: 'none' }}>
                {services.map((item, index) => (
                    <div key={index} className='flex flex-col border-[1px] border-primary pb-2 items-center overflow-hidden justify-center gap-1 rounded-lg  min-w-[255px] '>
                        <img src={`/${item.image}`} alt={item.name} className='w-full min-w-42 h-56 object-cover  mb-2' />
                        ...
                        <button className='px-4 py-2 w-[88%] border border-primary mt-2 text-black rounded-lg hover:bg-primary hover:text-bg-white transition-all duration-300'>
                            Book Now
                        </button>
                    </div>
                ))}
...
const Hero = () => {
    return (
        <div className='flex flex-col items-start gap-8 w-full py-16 px-32 justify-center h-full min-h-screen  ' style={{
